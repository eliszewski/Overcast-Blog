...
import static com.overcast.web.rest.TestUtil.sameInstant;
...
class PostResourceIT {
    ...
    public static Post createEntity(EntityManager em) {
        Post post = new Post().header(DEFAULT_HEADER).content(DEFAULT_CONTENT).date(DEFAULT_DATE);
        return post;
    }
    ...
    public static Post createUpdatedEntity(EntityManager em) {
        Post post = new Post().header(UPDATED_HEADER).content(UPDATED_CONTENT).date(UPDATED_DATE);
        return post;
    }
    ...
    void createPost() throws Exception {
        ...
        assertThat(testPost.getHeader()).isEqualTo(DEFAULT_HEADER);
    ...
    void putExistingPost() throws Exception {
        ...
        updatedPost.header(UPDATED_HEADER).content(UPDATED_CONTENT).date(UPDATED_DATE);
        ...
        Post testPost = postList.get(postList.size() - 1);
        assertThat(testPost.getHeader()).isEqualTo(UPDATED_HEADER);
    ...
    void fullUpdatePostWithPatch() throws Exception {
        ...
        partialUpdatedPost.header(UPDATED_HEADER).content(UPDATED_CONTENT).date(UPDATED_DATE);
