  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="overcastBlogApp.post.home.createOrEditLabel" data-cy="PostCreateUpdateHeading">
            <Translate contentKey="overcastBlogApp.post.home.createOrEditLabel">Create or edit a Post</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('overcastBlogApp.post.header')}
                id="post-header"
                name="header"
                data-cy="header"
                type="text"
              />
              <ValidatedField
                label={translate('overcastBlogApp.post.content')}
                id="post-content"
                name="content"
                data-cy="content"
                type="textarea"
              />
              <ValidatedField
                label={translate('overcastBlogApp.post.date')}
                id="post-date"
                name="date"
                data-cy="date"
                type="datetime-local"
              ...
              />
              <ValidatedField id="post-blog" name="blog" data-cy="blog" label={translate('overcastBlogApp.post.blog')} type="select">
                <option value="" key="0" />
                {blogs
