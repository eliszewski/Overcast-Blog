...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LINKTHEME_LIST actions', async () => {
    ...
    it('dispatches FETCH_LINKTHEME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LINKTHEME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LINKTHEME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LINKTHEME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LINKTHEME actions', async () => {
      const expectedActions = [
        {
