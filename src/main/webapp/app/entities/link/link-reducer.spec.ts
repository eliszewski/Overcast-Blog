...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './link.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LINK_LIST actions', async () => {
    ...
    it('dispatches FETCH_LINK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LINK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LINK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LINK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LINK actions', async () => {
      const expectedActions = [
        {
