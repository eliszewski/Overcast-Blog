...
import com.overcast.service.RatingService;
...
/**
 * REST controller for managing {@link com.overcast.domain.Rating}.
 */
@RestController
@RequestMapping("/api")
public class RatingResource {
     ...
     */
    @GetMapping("/ratings")
    public List<RatingDTO> getAllRatings(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
